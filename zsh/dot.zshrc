...
export PATH=$PATH:/home/gl/Documents/Clients/bin/:/home/gl/node_modules/.bin/:/home/gl/bin:/usr/local/bin:/usr/bin:/bin:/usr/local/games:/usr/games:$GOROOT/bin:$GOPATH/bin:/home/gl/anaconda2/bin
export PAGER="less -S"
...
if [ -f /home/gl/.tnsrc ]; then 
    source /home/gl/.tnsrc 
fi
###-tns-completion-end-###
